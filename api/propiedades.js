...
router.get('/', function (req, res, next) {
    const sql = "SELECT propiedades.id,  CONCAT('http://localhost:4001/uploads/', imagenes.url) AS imagen_url,, propiedades.precio_renta, propiedades.direccion, propiedades.num_habitaciones, propiedades.num_banos FROM propiedades JOIN imagenes ON propiedades.id = imagenes.propiedad_id  ";
